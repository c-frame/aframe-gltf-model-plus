...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/gh/c-frame/aframe-gltf-model-plus@813ac58/dist/aframe-master-custom-r168.min.js"></script>
...
```html
<script src="../../dist/aframe-master-custom-r168.min.js"></script>
